Dashboard::Application.routes.draw do
  ...
  resources :shortcuts, :roles, :languages, :skills, :responsibilities, :feeds, :my_own_feeds, except: [:show]
  ...
  get "/responsibilities/suggest" => "responsibilities#suggest", as: "responsibilities_suggest"
  get "/responsibilities/search" => "responsibilities#search", as: "responsibilities_search"
