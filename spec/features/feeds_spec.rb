...
describe "Feeds" do
  ...
  it "should have news feed entries" do
    expect(all("section.feeds .box-content li").count).to be > 1
  end

  it "should lazy load more combined news feed entries", js: true do
    before = all("section.feeds .box-content li").count
    ...
    sleep 0.2
    expect(before).to be < all("section.feeds .box-content li").count
  end
