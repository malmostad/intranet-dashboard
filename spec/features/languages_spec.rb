...
describe "Languages" do
  ...
  describe "administration" do
    ...
    it "should be available to admins" do
      expect(page).to have_selector('h1.box-title', text: "Språk")
    end
    ...
    it "should have an edit form" do
      ...
      expect(page).to have_selector('h1.box-title', text: "Redigera språk")
    end
    ...
    it "should not merge language without a second language" do
      ...
      expect(page).to have_selector(".warning", text: "Du måste välja ett språk från listan")
    end
